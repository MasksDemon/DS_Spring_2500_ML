...
def main():
    ...
    file_path = OUT_DIR / "model_performance_matrix.csv"
    ...
    plt.savefig(OUT_DIR / "figure1_bar_chart.png")
    plt.close()
    ...
    plt.savefig(OUT_DIR / "figure2_line_chart.png")
    plt.close()
    ...
    plt.savefig(OUT_DIR / "figure3_heatmap.png")
    plt.close()
